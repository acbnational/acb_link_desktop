...
class TestTaskScheduler:
    ...
    def test_windows_scheduler_type(self):
        ...
        from acb_link.scheduler import get_scheduler, WindowsTaskScheduler
    ...
    def test_macos_scheduler_type(self):
        ...
        from acb_link.scheduler import get_scheduler, MacOSTaskScheduler
...
class TestWindowsScheduler:
    ...
    def test_create_task_calls_schtasks(self, mock_run):
        ...
        from acb_link.scheduler import WindowsTaskScheduler, ScheduledTask, TaskType
...
class TestMacOSScheduler:
    ...
    def test_macos_label_prefix(self):
        ...
        if hasattr(scheduler, 'PLIST_PREFIX'):
            assert 'acb' in scheduler.PLIST_PREFIX.lower() or 'link' in scheduler.PLIST_PREFIX.lower()

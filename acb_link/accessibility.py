...
class ScreenReaderManager:
    ...
    def _init_accessible_output(self):
        ...
        try:
            ...
            self.logger.warning(
                "accessible_output2 not available. "
                "Screen reader announcements may be limited."
            )
            self._initialized = False
...
class ContrastValidator:
    ...
    def validate_scheme(self, scheme) -> List[str]:
        ...
        self._check_text(
            "Primary button text",
            scheme.button_primary_fg,
            scheme.button_primary_bg
        )
        self._check_text(
            "List text",
            scheme.list_fg,
        ...
        self._check_text(
            "Selected list text",
            scheme.list_selected_fg,
            scheme.list_selected_bg
        )
        self._check_text(
            "Input text",
            scheme.input_fg,

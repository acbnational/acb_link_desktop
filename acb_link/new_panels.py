...
class FavoritesPanel(wx.Panel):
    ...
    def __init__(
        ...
        parent, 
        favorites_manager,
        on_play_stream: Callable,
        on_play_episode: Callable
    ):
...
class PlaylistsPanel(wx.Panel):
    ...
    def _build_ui(self):
        ...
        self.repeat_choice = wx.Choice(right_panel, choices=["No Repeat", "Repeat All", "Repeat One"])
...
class CalendarPanel(wx.Panel):
    ...
    def _build_ui(self):
        ...
        view_sizer.Add(wx.StaticText(self, label="View:"), 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5)
        
        self.view_choice = wx.Choice(self, choices=["Today", "This Week", "This Month", "All Upcoming"])
    ...
    def _on_join_event(self, event):
        ...
        if idx != -1 and idx < len(self.current_events):
            ...
            if evt.stream_url:
                ...
                wx.MessageBox("This event doesn't have a stream or meeting URL.", "Info", wx.OK | wx.ICON_INFORMATION)
    ...
    def _on_set_reminder(self, event):
        ...
        if idx != -1 and idx < len(self.current_events):
            ...
            if dlg.ShowModal() == wx.ID_OK:
                ...
                wx.MessageBox(f"Reminder set for {minutes} minutes before.", "Reminder Set", wx.OK | wx.ICON_INFORMATION)
            dlg.Destroy()
...
class SleepTimerPanel(wx.Panel):
    ...
    def _build_ui(self):
        ...
        sizer.Add(wx.StaticText(self, label="Sleep Timer:"), 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5)
        
        self.timer_choice = wx.Choice(self, choices=[
            "Off", "15 min", "30 min", "45 min", "1 hour", "90 min", "2 hours"
        ])
...
class ShortcutsPanel(wx.Panel):
    ...
    def _build_ui(self):
        ...
        # Category filter
        filter_sizer = wx.BoxSizer(wx.HORIZONTAL)
        filter_sizer.Add(wx.StaticText(self, label="Category:"), 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5)
        ...
        key_sizer.Add(wx.StaticText(self, label="New shortcut:"), 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5)
    ...
    def _on_key_press(self, event):
        ...
        if key_code in (wx.WXK_CONTROL, wx.WXK_ALT, wx.WXK_SHIFT, wx.WXK_WINDOWS_LEFT, wx.WXK_WINDOWS_RIGHT):
            event.Skip()
            return
    ...
    def _on_import(self, event):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            if self.shortcut_manager.import_shortcuts(filepath):
                ...
                if self.on_shortcuts_changed:
                    self.on_shortcuts_changed()
                wx.MessageBox("Shortcuts imported successfully!", "Success", wx.OK | wx.ICON_INFORMATION)
            else:
    ...
    def _on_export(self, event):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            if self.shortcut_manager.export_shortcuts(filepath):
                wx.MessageBox("Shortcuts exported successfully!", "Success", wx.OK | wx.ICON_INFORMATION)
            else:

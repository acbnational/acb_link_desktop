...
class LiveDataConfig:
    ...
    streams: DataSourceConfig = field(default_factory=lambda: DataSourceConfig(
        name="streams",
    ...
    podcasts: DataSourceConfig = field(default_factory=lambda: DataSourceConfig(
        name="podcasts",
    ...
    state_affiliates: DataSourceConfig = field(default_factory=lambda: DataSourceConfig(
    ...
    special_interest_groups: DataSourceConfig = field(default_factory=lambda: DataSourceConfig(
    ...
    publications: DataSourceConfig = field(default_factory=lambda: DataSourceConfig(
        name="publications",
    ...
    categories: DataSourceConfig = field(default_factory=lambda: DataSourceConfig(
        name="categories",
    ...
    acb_sites: DataSourceConfig = field(default_factory=lambda: DataSourceConfig(
        name="acb_sites",
...
class UpdateConfig:
    ...
    github_api_url: str = "https://api.github.com/repos/acbnational/acb_link_desktop/releases/latest"
    download_url_template: str = "https://github.com/acbnational/acb_link_desktop/releases/download/v{version}/{filename}"
...
class PathConfig:
    ...
    def ensure_directories(self):
        ...
        for dir_path in [self.app_data_dir, self.cache_dir, self.logs_dir,
                         self.downloads_dir, self.recordings_dir]:
...
class AppConfig:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "AppConfig":
        ...
        if "live_data" in data:
            ...
            for source_name in ["streams", "podcasts", "state_affiliates",
                               "special_interest_groups", "publications",
                               "categories", "acb_sites"]:
